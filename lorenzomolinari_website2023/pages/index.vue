    ...
    <div class="flex flex-col items-center justify-center justify-items-center m-auto">
      ...
      <div class="flex md:flex-row lg:px-32 flex-col" style="margin-top: 20px;">
        <p class="mb-8 md:mr-3"
          style="border-color: white; border: 2px solid; border-radius: 15px; padding: 5px; font-size: large;"><nuxt-link
            to="projects">Projects</nuxt-link></p>
        <p class="mb-8 md:mr-3"
          style="border-color: white; border: 2px solid; border-radius: 15px; padding: 5px; font-size: large;"><nuxt-link
            to="blog">Blog</nuxt-link></p>
        <p class="mb-8 md:mr-3"
          style="border-color: white; border: 2px solid; border-radius: 15px; padding: 5px; font-size: large;"><nuxt-link
            to="findme">Find me</nuxt-link></p>
      </div>
